...
import ma.zs.zyn.dao.criteria.core.money.PurchaseItemCriteria;
import ma.zs.zyn.dao.facade.core.money.PurchaseItemDao;
import ma.zs.zyn.dao.specification.core.money.PurchaseItemSpecification;
...
import ma.zs.zyn.service.facade.client.catalog.ProductClientService ;
import ma.zs.zyn.bean.core.catalog.Product ;

import java.util.List;
@Service
public class PurchaseItemClientServiceImpl implements PurchaseItemClientService {
    ...
    @Autowired
    private PurchaseClientService purchaseService ;
    @Autowired
    private ProductClientService productService ;

    public PurchaseItemClientServiceImpl(PurchaseItemDao dao) {
        this.dao = dao;
    }
