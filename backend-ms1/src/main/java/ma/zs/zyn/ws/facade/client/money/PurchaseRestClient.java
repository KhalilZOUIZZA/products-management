...
public class PurchaseRestClient {
   ...
   public PurchaseRestClient(PurchaseClientService service, PurchaseConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PurchaseClientService service;
