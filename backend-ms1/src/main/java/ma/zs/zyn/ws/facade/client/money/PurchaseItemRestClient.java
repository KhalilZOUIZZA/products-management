package  ma.zs.zyn.ws.facade.client.money;
...
@RestController
@RequestMapping("/api/client/purchaseItem/")
public class PurchaseItemRestClient {
   ...
   public PurchaseItemRestClient(PurchaseItemClientService service, PurchaseItemConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PurchaseItemClientService service;
