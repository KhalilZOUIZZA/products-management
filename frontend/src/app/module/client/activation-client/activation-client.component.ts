...
@Component({
  selector: 'app-activation-client',
  templateUrl: './activation-client.component.html',
  styleUrls: ['./activation-client.component.css']
})
export class ActivationClientComponent implements OnInit {
