...
@Component({
  selector: 'app-purchase-create-client',
  templateUrl: './purchase-create-client.component.html'
})
export class PurchaseCreateClientComponent  implements OnInit {
   ...
   private _validPurchaseReference = true;
	...
	constructor(private service: PurchaseClientService , private productService: ProductClientService, private purchaseItemService: PurchaseItemClientService, private clientService: ClientClientService, @Inject(PLATFORM_ID) private platformId? ) {
